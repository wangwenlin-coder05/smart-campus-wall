<template>
	<view class="container">
		...
		<view class="banner-section">
			...
			>
				<swiper-item v-for="(banner, idx) in bannerList" :key="idx" @click="goBanner(banner)">
...
<script setup>
	...
	const bannerList = ref([{
			...
			title: '新人专享',
			desc: '首单立减5元',
			image: 'https://images.unsplash.com/photo-1517732306149-e8f829eb588a?w=750&h=300&fit=crop',
			link: '/pages/order/orderFetch'
		},
		{
			id: 2,
			title: '限时特惠',
			desc: '快递代取低至1.5元',
			image: 'https://images.unsplash.com/photo-1565043825793-6e0201870702?w=750&h=300&fit=crop',
			link: '/pages/order/orderFetch?parentType=1'
		},
		{
			id: 3,
			title: '会员日活动',
			desc: '全场8折起',
			image: 'https://images.unsplash.com/photo-1542744173-8e7e53415bb0?w=750&h=300&fit=crop',
			link: '/pages/organization/myOrganization'
		},
		{
			id: 4,
			title: '组局开黑',
			desc: '周末电竞派对',
			image: 'https://images.unsplash.com/photo-1524169358666-79f22534bc6e?w=750&h=300&fit=crop',
			link: '/pages/organization/organization'
		}
	])
	...
	const gridList = ref([{
			name: '互助接单',
			icon: '/static/index/small-Icon/mutual-aid.jpg',
			path: '/pages/order/partTimeOrder'
		},
		{
			name: '组局开黑',
			icon: '/static/index/small-Icon/team-up.jpg',
			path: '/pages/organization/organization'
		},
		{
			name: '二手商城',
			icon: '/static/index/small-Icon/second-hand.jpg',
			path: '/pages/shoppingMall/shoppingMall'
		},
		{
			name: '失物招领',
			icon: '/static/index/small-Icon/lost-found.jpg',
			path: '/pages/lostFound/lostFound'
		},
		{
			name: '打印文件',
			icon: '/static/index/small-Icon/file-print.jpg',
			path: '/pages/printFile/printFile'
		},
		{
			name: '专业交流',
			icon: '/static/index/small-Icon/professional-exchange.jpg',
			path: '/pages/professionalExchange/professionalExchange'
		},
		{
			name: '寻找伴侣',
			icon: '/static/index/small-Icon/find-partner.jpg',
			path: '/pages/partner/partner'
		},
		{
			name: '交流群',
			icon: '/static/index/small-Icon/discussion-group.jpg',
			path: '/pages/discussionGroup/discussionGroup'
		},
		{
			name: '瓜果生鲜',
...
<style scoped>
	...
	.container {
		min-height: 100vh;
		padding: calc(var(--status-bar-height) + 20rpx) 28rpx 160rpx;
	}
